...
1.  Keep development environments isolated from production.
2.  Keep secrets outside source code.
3.  Validate data at system boundaries.
4.  Keep AI output structured and validated.
5.  Keep critical business rules deterministic.
6.  Keep n8n focused on orchestration.
7.  Keep FastAPI responsible for the application/API boundary.
8.  Keep SQL as the source of truth.
9.  Keep React responsible for presentation and interaction.
10. Test changes before merging.
11. Document significant technical changes.
12. Use Git branches for feature development.
13. Prefer simple solutions over unnecessary complexity.
14. Keep the development environment reproducible.

------------------------------------------------------------------------

## Document Status

**Document:** DEVELOPMENT_SETUP.md\
**Version:** 0.1\
**Status:** Draft / Implementation Ready\
